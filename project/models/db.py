...
db.define_table(
    ...
    Field('dodgeball_high_score', writable=False, readable=False, default='0'),
    Field('memorygame_high_score', writable=False, readable=False, default='0')
    )
